...
\documentclass[
    ...
    % Title
    Title           = 全球水稻遥感时空动态监测及其冷岛效应研究,
    TitleEng        = {{Global}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{全球水稻时空动态遥感监测}{及其地表生物物理降温效应研究}
\titleengtwolines{Global Rice Spatial-temporal Dynamics and}{Associated Land Surface Cooling Effects}
