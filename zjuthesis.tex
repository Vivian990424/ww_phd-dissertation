...
\documentclass[
    ...
    % Title
    Title           = 全球长时序逐日水稻种植区遥感提取及其地表降温效应研究,
    TitleEng        = {{Long-Term Daily Mapping of Global Rice Based on Satellite Remote Sensing and Analysis of Its Land Surface Cooling Effects}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{全球长时序逐日水稻种植区遥感提取}{及其地表降温效应研究}
% \titleengtwolines{Global Long-Term Daily Rice Mapping Based on Satellite Remote Sensing}{and Land Surface Cooling Effects of Rice Cultivation}
\titleengthreelines{Long-Term Daily Mapping of Global Rice}{Based on Satellite Remote Sensing and}{Analysis of Its Land Surface Cooling Effects}
