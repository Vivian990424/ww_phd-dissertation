...
\documentclass[
    ...
    % Title
    Title           = 全球长时序水稻遥感制图及其冷岛效应研究,
    TitleEng        = {{Global Long-term Rice Mapping and the Paddy Fields Cooling Island Effect}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{全球长时序水稻遥感制图}{及其冷岛效应研究}
\titleengtwolines{Global Long-term Rice Mapping}{and the Paddy Fields Cooling Island Effect}
