...
\documentclass[
    ...
    TitleEng        = {{Global Long-Term Daily Rice Mapping and Associated Land Surface Cooling Effects}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{全球长时序逐日水稻种植区遥感提取}{及其地表降温效应研究}
\titleengtwolines{Global Long-Term Daily Rice Mapping and}{Land Surface Cooling Effects Assessment}
